...
public class SubFragment3 extends BaseFragment {
    ...
    protected void initView(Bundle savedInstanceState) {
        setContentView(R.layout.fragment_sub3);
    ...
    private void initLayout(){
        mScrollView = (PullToRefreshScrollView) getViewById(R.id.yx_list_scrollview);
		/*
         * Mode.BOTH：同时支持上拉下拉
         ...
         * 首页buanner
         * */
        banner = (BGABanner) getViewById(R.id.yx_list_bgabanner4);
        // 用Java代码方式设置切换动画
...
//				AppManager.getAppManager().startNextActivity(getActivity(), MyWebActivity.class, intent);
        ...
        lv_yx= (MyListView) getViewById(R.id.item_yx_list_lv_info);
                ...
                if (!TextUtils.isEmpty(response.toString())) {
                    ...
                    if (mInfoJson.getResult().equals("1")) {
                        ...
                        if (!(mInfoJson.getList() == null || mInfoJson.getList().size() == 0 ||  "".equals(mInfoJson.getList()))) {
                            ...
                            mRecommendedYxListAdapter = new RecommendedYxListAdapter(getActivity(),list);
