...
public class ImageLoaderHelper
{
	...
	public static ImageLoaderHelper getInstance()
	{
		...
		if (mInstance == null)
		{
			synchronized (ImageLoaderHelper.class)
			{
				if (mInstance == null)
				{
					mInstance = new ImageLoaderHelper(1, Type.LIFO);
				}
			}
		}
		return mInstance;
	...
	private ImageLoaderHelper(int threadCount, Type type)
	{
	 ...
	 * @return
	 */
	public static ImageLoaderHelper getInstance(int threadCount, Type type)
	{
		...
		if (mInstance == null)
		{
			synchronized (ImageLoaderHelper.class)
			{
				if (mInstance == null)
				{
					mInstance = new ImageLoaderHelper(threadCount, type);
				}
			}
		}
		return mInstance;
