 ...
 */
public class RecommendedMarketAdapter extends BaseAdapter {
    private List<IndexJson.Yxlist> list;
    private Context context;

    public RecommendedMarketAdapter(Context context, List<IndexJson.Yxlist> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView=inflater.inflate(R.layout.item_recommended_market,null);

            mHolder.img_icon = (ImageView) convertView.findViewById(R.id.item_recommended_market_img_icon);
            mHolder.img_share = (ImageView) convertView.findViewById(R.id.item_recommended_market_img_share);
            mHolder.tv_name = (TextView) convertView.findViewById(R.id.item_recommended_market_tv_name);
            mHolder.tv_times = (TextView) convertView.findViewById(R.id.item_recommended_market_tv_times);
            mHolder.tv_num = (TextView) convertView.findViewById(R.id.item_recommended_market_tv_num);

            mHolder.tv_name2 = (TextView) convertView.findViewById(R.id.item_recommended_market_tv_name2);
            mHolder.tv_times2 = (TextView) convertView.findViewById(R.id.item_recommended_market_tv_times2);
            mHolder.tv_num2 = (TextView) convertView.findViewById(R.id.item_recommended_market_tv_num2);
            mHolder.img_icon1 = (ImageView) convertView.findViewById(R.id.item_recommended_market_img_icon1);
            mHolder.img_icon2 = (ImageView) convertView.findViewById(R.id.item_recommended_market_img_icon2);
            mHolder.img_icon3 = (ImageView) convertView.findViewById(R.id.item_recommended_market_img_icon3);

            mHolder.ll_type1 = (LinearLayout) convertView.findViewById(R.id.item_recommended_market_ll_type1);
            mHolder.ll_type2 = (LinearLayout) convertView.findViewById(R.id.item_recommended_market_ll_type2);

            mHolder.img_new= (ImageView) convertView.findViewById(R.id.item_recommended_market_img_new);
            mHolder.img_new2= (ImageView) convertView.findViewById(R.id.item_recommended_market_img_new2);

//            mHolder.view_divide=convertView.findViewById(R.id.item_recommended_market_view);
        ...
        if(TextUtils.isEmpty(list.get(position).getG_pic2())){
            ...
            if(!TextUtils.isEmpty(list.get(position).getG_pic())){
                ...
                ImageLoader.getInstance().displayImage(String.valueOf(R.drawable.icon_loading),mHolder.img_icon,ImageLoaderOptions.getOptions());
            }
...
//                mHolder.img_new.setVisibility(View.GONE);
            ...
            if(!TextUtils.isEmpty(list.get(position).getG_pic())){
                ...
                ImageLoader.getInstance().displayImage(String.valueOf(R.drawable.icon_loading),mHolder.img_icon1,ImageLoaderOptions.getOptions());
            }
            if(!TextUtils.isEmpty(list.get(position).getG_pic1())){
                ...
                ImageLoader.getInstance().displayImage(String.valueOf(R.drawable.icon_loading),mHolder.img_icon2,ImageLoaderOptions.getOptions());
            }
            if(!TextUtils.isEmpty(list.get(position).getG_pic2())){
                if(list.get(position).getG_pic().startsWith("http")){
                ...
                ImageLoader.getInstance().displayImage(String.valueOf(R.drawable.icon_loading),mHolder.img_icon3,ImageLoaderOptions.getOptions());
            }
...
//        }
    ...
    class ViewHolder{
        ...
        private ImageView img_new,img_new2;
