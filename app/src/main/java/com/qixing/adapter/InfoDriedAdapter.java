 ...
 */
public class InfoDriedAdapter extends BaseAdapter{
    private List<InfoDriedJson.QxDried> list ;
    private Context context;
    public InfoDriedAdapter(Context context, List<InfoDriedJson.QxDried> list) {
        this.list = list;
