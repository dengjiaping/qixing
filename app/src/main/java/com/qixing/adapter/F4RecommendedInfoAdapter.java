 ...
 */
public class F4RecommendedInfoAdapter extends BaseAdapter{
    private List<InfoJson.QxInfo> list; ;
    private Context context;
    public F4RecommendedInfoAdapter(Context context, List<InfoJson.QxInfo> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            convertView=inflater.inflate(R.layout.item_fragment4_info,null);

            mHolder.img_icon = (ImageView) convertView.findViewById(R.id.item_fragment4_info_img_icon);
            mHolder.img_share = (ImageView) convertView.findViewById(R.id.item_fragment4_info_img_share);
            mHolder.tv_name = (TextView) convertView.findViewById(R.id.item_fragment4_info_tv_name);
            mHolder.tv_times = (TextView) convertView.findViewById(R.id.item_fragment4_info_tv_times);
            mHolder.tv_num = (TextView) convertView.findViewById(R.id.item_fragment4_info_tv_num);

            mHolder.tv_name2 = (TextView) convertView.findViewById(R.id.item_fragment4_info_tv_name2);
            mHolder.tv_times2 = (TextView) convertView.findViewById(R.id.item_fragment4_info_tv_times2);
            mHolder.tv_num2 = (TextView) convertView.findViewById(R.id.item_fragment4_info_tv_num2);
            mHolder.img_icon1 = (ImageView) convertView.findViewById(R.id.item_fragment4_info_img_icon1);
            mHolder.img_icon2 = (ImageView) convertView.findViewById(R.id.item_fragment4_info_img_icon2);
            mHolder.img_icon3 = (ImageView) convertView.findViewById(R.id.item_fragment4_info_img_icon3);

            mHolder.ll_type1 = (LinearLayout) convertView.findViewById(R.id.item_fragment4_info_ll_type1);
            mHolder.ll_type2 = (LinearLayout) convertView.findViewById(R.id.item_fragment4_info_ll_type2);

            mHolder.img_new= (ImageView) convertView.findViewById(R.id.item_fragment4_info_img_new);
            mHolder.img_new2= (ImageView) convertView.findViewById(R.id.item_fragment4_info_img_new2);
