    ...
    private void initView() {
        ...
        mTitleBar.setDelegate(new BGATitlebar.BGATitlebarDelegate() {
            ...
            public void onClickRightCtv() {
                ...
                str_Feedback = edit_name.getText().toString().trim();
                if(TextUtils.isEmpty(str_Feedback)){
                    Toasts.show("意见反馈不能为空");
                }else{
                    initDatas(str_Feedback);
                }
            }
        });
...
//                Log.i(TAG, "输入文字后的状态");
    ...
    private void initDatas(String str_Feedback) {
//        initTestData();
        ...
        params.put("conten", str_Feedback);//+"/p/"+p
        final String url = Constant.BASE_URL + Constant.URL_USERAPI_YJFK;
        System.out.println("===========================个人中心 意见反馈 url ===== " + url);
        ...
        mAsyncHttpClient.post(mContext, url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                System.out.println("===========================个人中心 意见反馈 response ===== " + response.toString());
