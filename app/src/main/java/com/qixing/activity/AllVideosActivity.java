...
public class AllVideosActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.activity_all_videos, null);
        setContentView(view);
...
//        });
        ...
        mGridView.setFocusable(false);// scrollview嵌套listview运行后最先显示出来的位置不在顶部问题
...
//                         tv_juan1,tv_juan2,tv_juan3;
                        if (mF2RecommendedVideoJson.getList().size() == 0 || mF2RecommendedVideoJson.getList() == null || "".equals(mF2RecommendedVideoJson.getList())) {
                            ...
                            mAdapter = new AllVideoAdapter(mContext, list);
