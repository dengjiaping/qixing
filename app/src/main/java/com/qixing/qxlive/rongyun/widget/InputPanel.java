package com.qixing.qxlive.rongyun.widget;
...
//        imm.showSoftInput(textEditor,InputMethodManager.SHOW_FORCED);
        ...
        InputMethodManager inputManager = (InputMethodManager)textEditor.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
