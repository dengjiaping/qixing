package com.qixing.qxlive.rongyun.fakeserver;
...
public class FakeServer {
     ...
     */
//    public static final String APP_KEY = "ik1qhw09ifmxp";//测试
    public static final String APP_KEY = "pwe86ga5ptob6";//正式
    /**
     * 务必妥善保存, 不能放在应用端, 否则可以被反编译获得.
     */
//    public static final String APP_SECRET = "oaq6kIVhVjbCZF";//测试
    public static final String APP_SECRET = "K3piiGSGUX8";//正式
    ...
    public static UserInfo getUserInfo() {
        return new UserInfo(MyApplication.getInstance().getUid(), MyApplication.getInstance().getNickname(), Uri.parse(Constant.BASE_URL_IMG + MyApplication.getInstance().getUser_Head()));
    }
}