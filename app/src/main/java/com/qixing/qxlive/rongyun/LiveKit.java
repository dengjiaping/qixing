package com.qixing.qxlive.rongyun;

import android.content.Context;
import android.os.Handler;

import com.qixing.qxlive.rongyun.controller.EmojiManager;
import com.qixing.qxlive.rongyun.ui.message.BaseMsgView;
import com.qixing.qxlive.rongyun.ui.message.GiftMessage;
import com.qixing.qxlive.rongyun.ui.message.GiftMsgView;
import com.qixing.qxlive.rongyun.ui.message.InfoMsgView;
import com.qixing.qxlive.rongyun.ui.message.TextMsgView;
...
public class LiveKit {
     ...
     * 当前聊天室房间id
     */
    private static String OnReceiveMsg;
...
//     * 获取消息记录
//     * */
//    public static String getOnReceiveMsg(){
//        return OnReceiveMsg;
//    }
//
//    /**
//     * 获取消息记录监听器
//     * */
//    public static RongIMClient.OnReceiveMessageListener getOnReceiveMessageListener(){
...
//    }
     ...
     * 设置消息记录监听器
     * */
    public static void setOnReceiveMessageListener(RongIMClient.OnReceiveMessageListener mOnReceiveMessageListener){
